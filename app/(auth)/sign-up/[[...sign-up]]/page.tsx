...
const SigUpPage = () => {
  ...
  const forceRedirectUrl = process.env.NEXT_PUBLIC_CLERK_SIGN_UP_FORCE_REDIRECT_URL || '/';
  console.log(forceRedirectUrl)
  return (
    <main className='flex-center flex min-h-screen w-full flex-col gap-6 bg-auth-light bg-cover bg-center bg-no-repeat dark:bg-auth-dark'>
      ...
      <SignUp signInFallbackRedirectUrl={forceRedirectUrl} />
    </main>
  )
}
